    ...
    <div class="auth-root">
      ...
      <section class="auth-hero">
        <div class="auth-hero-inner">
          <div class="hero-left">
            <h1 class="hero-title anim-up">Centralize Your<br><span class="gradient-text">Book Assets</span></h1>
            <p class="hero-sub anim-up d2">
              Join authors using AuthorVault to manage every file, blurb, platform version, and marketing asset from a single source of truth.
            </p>
            <div class="hero-badges anim-up d3">
              ...
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg> File Management</span>
              <span class="badge-pill"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/></svg> 4+ Platforms</span>
            </div>
          </div>
